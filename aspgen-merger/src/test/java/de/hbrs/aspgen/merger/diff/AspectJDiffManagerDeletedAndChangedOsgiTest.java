...
public class AspectJDiffManagerDeletedAndChangedOsgiTest {
    ...
    public void changedAndDeletedBlock() throws IOException {
        final String fileContent = FileUtils.readFileToString(new File("src/test/resources/ajdiff/changedAndDeleted/osgi/Person_Osgi_Deleted_Block.aj"));
        final String generatedFromJavaFile = FileUtils.readFileToString(new File("src/test/resources/ajdiff/changedAndDeleted/osgi/Person_Osgi_Original.aj"));
        final String generatedFromJavaFile2 = FileUtils.readFileToString(new File("src/test/resources/ajdiff/changedAndDeleted/osgi/Person_Osgi.aj"));
        ...
        assertEquals("Service Init", result.getAspectJFieldDiffs().get(0).getAnnotationData().getModified().get(0));
