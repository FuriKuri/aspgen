...
public privileged aspect Person_JavaBean {
    @Generated(id = {newid1}, name = "Logging", data = "private:int:calc;int:h,String:name;")
    before(int h, String name) : execution(public int Person.calc(int, String)) && args(h, name) {
        System.out.println(h);
        System.out.println(name);
    }

    @Generated(id = {newid2}, name = "Logging", data = "private:void:doSomething2;String:name,String:amount,String:bla;")
